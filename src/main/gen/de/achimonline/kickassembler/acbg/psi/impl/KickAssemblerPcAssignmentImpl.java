...
public class KickAssemblerPcAssignmentImpl extends ASTWrapperPsiElement implements KickAssemblerPcAssignment {

  public KickAssemblerPcAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitPcAssignment(this);
  }
