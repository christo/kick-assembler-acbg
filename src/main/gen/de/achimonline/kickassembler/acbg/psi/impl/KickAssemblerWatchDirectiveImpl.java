...
public class KickAssemblerWatchDirectiveImpl extends ASTWrapperPsiElement implements KickAssemblerWatchDirective {

  public KickAssemblerWatchDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitWatchDirective(this);
  }
