...
public class KickAssemblerBreakDirectiveImpl extends ASTWrapperPsiElement implements KickAssemblerBreakDirective {

  public KickAssemblerBreakDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitBreakDirective(this);
  }
