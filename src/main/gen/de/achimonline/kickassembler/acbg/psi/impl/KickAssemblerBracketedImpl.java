...
public class KickAssemblerBracketedImpl extends ASTWrapperPsiElement implements KickAssemblerBracketed {

  public KickAssemblerBracketedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitBracketed(this);
  }
