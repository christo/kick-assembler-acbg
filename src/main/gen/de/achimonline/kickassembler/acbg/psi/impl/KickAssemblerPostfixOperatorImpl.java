...
public class KickAssemblerPostfixOperatorImpl extends ASTWrapperPsiElement implements KickAssemblerPostfixOperator {

  public KickAssemblerPostfixOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
