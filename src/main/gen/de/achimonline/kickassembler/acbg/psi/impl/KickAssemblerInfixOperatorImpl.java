...
public class KickAssemblerInfixOperatorImpl extends ASTWrapperPsiElement implements KickAssemblerInfixOperator {

  public KickAssemblerInfixOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
