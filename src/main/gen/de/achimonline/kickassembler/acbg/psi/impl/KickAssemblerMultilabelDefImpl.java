...
public class KickAssemblerMultilabelDefImpl extends ASTWrapperPsiElement implements KickAssemblerMultilabelDef {

  public KickAssemblerMultilabelDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitMultilabelDef(this);
  }
