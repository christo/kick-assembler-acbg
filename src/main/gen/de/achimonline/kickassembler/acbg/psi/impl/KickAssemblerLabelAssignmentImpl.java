...
public class KickAssemblerLabelAssignmentImpl extends ASTWrapperPsiElement implements KickAssemblerLabelAssignment {

  public KickAssemblerLabelAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitLabelAssignment(this);
  }
