...
public class KickAssemblerEvalExpressionImpl extends ASTWrapperPsiElement implements KickAssemblerEvalExpression {

  public KickAssemblerEvalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
