...
public class KickAssemblerArgumentImpl extends ASTWrapperPsiElement implements KickAssemblerArgument {

  public KickAssemblerArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }
