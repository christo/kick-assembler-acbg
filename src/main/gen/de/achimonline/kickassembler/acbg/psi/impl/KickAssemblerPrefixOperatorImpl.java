...
public class KickAssemblerPrefixOperatorImpl extends ASTWrapperPsiElement implements KickAssemblerPrefixOperator {

  public KickAssemblerPrefixOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
