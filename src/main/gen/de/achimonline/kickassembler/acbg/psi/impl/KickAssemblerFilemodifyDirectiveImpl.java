...
public class KickAssemblerFilemodifyDirectiveImpl extends ASTWrapperPsiElement implements KickAssemblerFilemodifyDirective {

  public KickAssemblerFilemodifyDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitFilemodifyDirective(this);
  }
