...
public class KickAssemblerPseudoPcAssignmentImpl extends ASTWrapperPsiElement implements KickAssemblerPseudoPcAssignment {

  public KickAssemblerPseudoPcAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitPseudoPcAssignment(this);
  }
