...
public class KickAssemblerReturnStatementImpl extends ASTWrapperPsiElement implements KickAssemblerReturnStatement {

  public KickAssemblerReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
