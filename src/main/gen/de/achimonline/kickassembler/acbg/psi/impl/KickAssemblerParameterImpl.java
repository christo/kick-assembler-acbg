...
public class KickAssemblerParameterImpl extends ASTWrapperPsiElement implements KickAssemblerParameter {

  public KickAssemblerParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
