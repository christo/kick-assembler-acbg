...
public class KickAssemblerMultilabelImpl extends ASTWrapperPsiElement implements KickAssemblerMultilabel {

  public KickAssemblerMultilabelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitMultilabel(this);
  }
