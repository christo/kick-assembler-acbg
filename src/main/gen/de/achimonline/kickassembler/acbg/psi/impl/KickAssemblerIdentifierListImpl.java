...
public class KickAssemblerIdentifierListImpl extends ASTWrapperPsiElement implements KickAssemblerIdentifierList {

  public KickAssemblerIdentifierListImpl(@NotNull ASTNode node) {
    super(node);
  }
