...
public class KickAssemblerPreprocessorDirectiveImpl extends ASTWrapperPsiElement implements KickAssemblerPreprocessorDirective {

  public KickAssemblerPreprocessorDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
