...
public class KickAssemblerImportOnceImpl extends ASTWrapperPsiElement implements KickAssemblerImportOnce {

  public KickAssemblerImportOnceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitImportOnce(this);
  }
