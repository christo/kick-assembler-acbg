...
public class KickAssemblerNamespaceDirectiveImpl extends ASTWrapperPsiElement implements KickAssemblerNamespaceDirective {

  public KickAssemblerNamespaceDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
