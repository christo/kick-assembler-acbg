...
public class KickAssemblerDefExprImpl extends ASTWrapperPsiElement implements KickAssemblerDefExpr {

  public KickAssemblerDefExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitDefExpr(this);
  }
